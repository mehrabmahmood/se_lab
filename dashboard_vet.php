...
<head>
  ...
  <title><?= h(APP_NAME) ?> - Vet Dashboard</title>
...
<?php endif; ?>
  ...
  <div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold">Vet Dashboard</h1>
    ...
    <div class="bg-white rounded-2xl shadow p-6">
      ...
      <p class="text-gray-600 mt-2">Role: <span class="font-semibold">Vet</span></p>
      ...
      <div class="mt-4 p-4 rounded-lg bg-blue-50 text-blue-900 text-sm flex items-center justify-between">
        <div>
          <div class="font-semibold">JIT Token Demo</div>
          <div class="text-blue-800">View a separate patient database using a short-lived token.</div>
        </div>
        <a class="px-4 py-2 rounded-lg border border-blue-300 text-blue-900 hover:bg-blue-100" href="<?= h(APP_BASE_URL) ?>/previous_patients.php">
          Previous Patients
        </a>
      </div>
